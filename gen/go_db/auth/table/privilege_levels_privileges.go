...
func newPrivilegeLevelsPrivilegesTableImpl(schemaName, tableName, alias string) privilegeLevelsPrivilegesTable {
	var (
		...
		allColumns             = postgres.ColumnList{IDColumn, PrivilegeIDColumn, PrivilegeLevelIDColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns         = postgres.ColumnList{PrivilegeIDColumn, PrivilegeLevelIDColumn, CreatedAtColumn, UpdatedAtColumn}
	)
