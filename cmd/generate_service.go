...
func generateService() {
	...
	contextServicePath := fmt.Sprintf("%s/internal/context/service.go", wd)
	serviceMgrPath := fmt.Sprintf("%s/internal/services/service_manager.go", wd)
...
func writeServiceContents(w io.Writer, name string) {
